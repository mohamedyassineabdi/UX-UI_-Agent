...
def _accessibility_validation_evidence(check: str) -> dict[str, object]:
    return {
        "validation_method": "mobile_accessibility_scanner_static_figma_gate",
        "validation_source": ACCESSIBILITY_SCANNER_SOURCE,
        "validation_question": (
            "Can users with visual or motor accessibility needs perceive the content and operate visible controls?"
        ),
